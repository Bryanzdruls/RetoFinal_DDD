...
public class ChangedTurnReverse extends DomainEvent {
    ...
    public ChangedTurnReverse(String type) {
        super(EventEnum.CHANGED_TURN.name());
    }

    public ChangedTurnReverse(String boardId, String turnId, String turnPlayerName, Queue<String> playersInGame) {
        super(EventEnum.CHANGED_TURN.name());
